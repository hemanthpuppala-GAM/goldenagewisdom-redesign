...
function SceneSilence() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      <Backdrop />
      <KenBurns src="assets/hero.png" from={1.06} to={1.18} origin="50% 30%" dim={0.4} />
...
function SceneBreath() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      <Backdrop />
      <KenBurns src="assets/meditation.png" from={1.02} to={1.14} origin="50% 45%" dim={0.35} />
      <div style={{ position: 'absolute', inset: 0, opacity: o }}>
...
function SceneCrown() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      <Backdrop />
      <KenBurns src="assets/hero.png" from={1.3} to={1.6} origin="50% 6%" dim={0.4} />
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      <div style={{ position: 'absolute', inset: 0, opacity: o, transform: `scale(${s})`, transformOrigin: '50% 45%' }}>
        <img src="assets/meditation.png" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', objectPosition: '50% 38%' }} />
...
function SceneOneness() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      <Backdrop />
      <KenBurns src="assets/golden-crowd.png" from={1.35} to={1.02} origin="50% 30%" dim={0.3} />
      <div style={{ position: 'absolute', inset: 0, opacity: o }}>
        {[0, 1, 2].map((i) => {
...
function SceneWithin() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      <Backdrop />
      <KenBurns src="assets/hero.png" from={1.02} to={1.12} origin="50% 55%" dim={0.3} />
      <div style={{ position: 'absolute', inset: 0, opacity: o }}>
        {[0, 1, 2].map((i) => {
...
function SceneTogether() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      <Backdrop />
      <KenBurns src="assets/golden-crowd.png" from={1.05} to={1.28} origin="50% 42%" dim={0.35} />
      <div style={{ position: 'absolute', inset: 0, opacity: o }}>
        {[0, 1, 2].map((i) => {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      <div style={{ position: 'absolute', inset: 0, opacity: sun * 0.5 }}>
        <img src="assets/golden-crowd.png" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', objectPosition: '50% 70%', transform: `scale(${1.05 + 0.1 * MOTION.smooth(progress)})` }} />
...
window.GAW_UNLOCK = function () {
  try {
    const ctx = ensureCtx();
    ctx.resume();
    if (window.speechSynthesis) { const u = new SpeechSynthesisUtterance(' '); u.volume = 0; speechSynthesis.speak(u); speechSynthesis.resume(); }
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: (props && props.embed) ? '100%' : 'calc(100vh - 64px)', minHeight: (props && props.embed) ? 0 : 420, background: BG }}>
      ...
      <TweaksPanel>
        ...
        <TweakToggle label="Narration + score (mastered)" value={t.music} onChange={(v) => setTweak('music', v)} />
